...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/TomaL.AbbU.OkkE', {
...
os.system('xdg-open https://www.facebook.com/TomaL.AbbU.OkkE')
